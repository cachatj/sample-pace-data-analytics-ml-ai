...
module "vht_claims_denial_mgmt_producer_project" {
  ...
  GLUE_DATABASE       = "${var.APP}_${var.ENV}_vht_claims_denial_mgmt_producer_lakehouse"
...
resource "aws_ssm_parameter" "vht_claims_denial_mgmt_producer_project_id" {
  name  = "/${var.APP}/${var.ENV}/projects/vht-claims-denial-mgmt-producer/project_id"
  type  = "String"
  value = module.vht_claims_denial_mgmt_producer_project.project_id
...
resource "aws_ssm_parameter" "vht_claims_denial_mgmt_producer_project_arn" {
  name  = "/${var.APP}/${var.ENV}/projects/vht-claims-denial-mgmt-producer/project_arn"
  type  = "String"
  value = module.vht_claims_denial_mgmt_producer_project.project_arn
