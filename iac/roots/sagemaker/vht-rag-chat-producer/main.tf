...
module "vht_rag_chat_producer_project" {
  ...
  GLUE_DATABASE       = "${var.APP}_${var.ENV}_vht_rag_chat_producer_lakehouse"
...
resource "aws_ssm_parameter" "vht_rag_chat_producer_project_id" {
  name  = "/${var.APP}/${var.ENV}/projects/vht-rag-chat-producer/project_id"
  type  = "String"
  value = module.vht_rag_chat_producer_project.project_id
...
resource "aws_ssm_parameter" "vht_rag_chat_producer_project_arn" {
  name  = "/${var.APP}/${var.ENV}/projects/vht-rag-chat-producer/project_arn"
  type  = "String"
  value = module.vht_rag_chat_producer_project.project_arn
