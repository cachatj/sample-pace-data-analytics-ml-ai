...
module "vht_claims_lakehouse_project" {
  ...
  GLUE_DATABASE       = "${var.APP}_${var.ENV}_vht_claims_lakehouse_lakehouse"
...
resource "aws_ssm_parameter" "vht_claims_lakehouse_project_id" {
  name  = "/${var.APP}/${var.ENV}/projects/vht-claims-lakehouse/project_id"
  type  = "String"
...
resource "aws_ssm_parameter" "vht_claims_lakehouse_project_arn" {
  name  = "/${var.APP}/${var.ENV}/projects/vht-claims-lakehouse/project_arn"
  type  = "String"
