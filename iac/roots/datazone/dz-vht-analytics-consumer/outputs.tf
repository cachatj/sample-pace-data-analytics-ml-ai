...
output "datazone_project_id" {
  ...
  value       = module.vht_analytics_consumer_datazone_project.project_id
}
...
output "datazone_environment_id" {
  ...
  value       = module.vht_analytics_consumer_datazone_project.environment_id
}

output "datazone_profile_id" {
  description = "DataZone profile ID"
  value       = module.vht_analytics_consumer_datazone_project.profile_id
}
