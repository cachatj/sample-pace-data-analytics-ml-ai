...
output "s3_table_bucket" {
  ...
  value       = module.vht_claims_lakehouse_datalake.s3_table_bucket
}

output "support_bucket" {
  description = "S3 bucket for support files"
  value       = module.vht_claims_lakehouse_datalake.support_bucket
}

output "table_metadata" {
  description = "Table metadata and schemas"
  value       = module.vht_claims_lakehouse_datalake.table_metadata
}
