...
module "vht_rag_chat_producer_datalake" {
  ...
  DATABASE_NAME      = "${var.APP}_${var.ENV}_vht_rag_chat_producer_lakehouse"
...
resource "aws_ssm_parameter" "vht_rag_chat_producer_database_name" {
  name  = "/${var.APP}/${var.ENV}/datalakes/vht_rag_chat_producer/database_name"
  type  = "String"
