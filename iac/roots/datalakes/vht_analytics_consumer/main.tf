...
module "vht_analytics_consumer_datalake" {
  ...
  DATABASE_NAME      = "${var.APP}_${var.ENV}_vht_analytics_consumer_lakehouse"
...
resource "aws_ssm_parameter" "vht_analytics_consumer_database_name" {
  name  = "/${var.APP}/${var.ENV}/datalakes/vht_analytics_consumer/database_name"
  type  = "String"
  value = module.vht_analytics_consumer_datalake.database_name
