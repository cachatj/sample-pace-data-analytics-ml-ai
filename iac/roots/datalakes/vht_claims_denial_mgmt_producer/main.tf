...
module "vht_claims_denial_mgmt_producer_datalake" {
  ...
  DATABASE_NAME      = "${var.APP}_${var.ENV}_vht_claims_denial_mgmt_producer_lakehouse"
...
resource "aws_ssm_parameter" "vht_claims_denial_mgmt_producer_database_name" {
  name  = "/${var.APP}/${var.ENV}/datalakes/vht_claims_denial_mgmt_producer/database_name"
  type  = "String"
  value = module.vht_claims_denial_mgmt_producer_datalake.database_name
